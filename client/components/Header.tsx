      ...
      >
        <div className="flex items-center justify-center max-w-[1920px] mx-auto px-2 py-0 md:px-2 lg:px-4 h-[150px]">
          <nav className="w-full grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] justify-center items-center relative">
            ...
            {/* CENTER LOGO */}
            <div className="flex items-center justify-center gap-0 md:gap-4 lg:gap-[5px] my-0 lg:my-0">
              {/* PROJS */}
              <Link
                to="/projects"
                onMouseEnter={() => handleHover("left", true)}
                ...
                className="text-text-accent text-3xl md:text-3xl lg:text-[40px] whitespace-nowrap md:hover:opacity-70 lg:hover:opacity-70 transition-opacity z-50"
              >
                PROJS
              </Link>
            ...
            <div
              onMouseEnter={() => handleHover("right", true)}
              onMouseLeave={() => handleHover("right", false)}
              className={`flex flex-col lg:flex-row items-end lg:items-start justify-start gap-2 md:gap-8 lg:gap-[111px] pl-0 md:pl-4 lg:pl-[58px] text-sm md:text-base lg:text-xl absolute lg:static right-0 top-12 lg:top-full
            transition-all duration-300 transform

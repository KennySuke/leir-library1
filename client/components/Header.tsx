        ...
        <div className="flex items-center justify-start max-w-[1920px] mx-auto px-2 py-0 md:px-2 lg:px-4 h-[150px]">
          <nav className="w-full grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] justify-center items-center relative">
            ...
            <div
              ...
              className={`flex flex-col lg:flex-row items-start lg:items-start justify-end gap-3 md:gap-2 lg:gap-[20px] pr-0 md:pr-4 lg:pr-[58px] text-sm md:text-base lg:text-xl absolute lg:static left-0 top-5 lg:top-full

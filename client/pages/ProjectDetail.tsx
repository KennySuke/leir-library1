  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="w-full">
        ...
        <div className="flex flex-col items-center gap-20 md:gap-32 px-4 md:px-8 lg:px-16 pt-32 pb-20">
          
          {/* Hero Section */}
          <div className="flex flex-col items-center gap-0 w-full max-w-7xl">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 lg:gap-12 w-full lg:pl-8">
              ...
              <div className="flex flex-col gap-8 w-full lg:w-[55%]">
                ...
                {/* Info box */}
                <div className="border-2 border-white/70 p-4 md:p-6">
                  <div className="text-sm md:text-base lg:text-xl max-w-[503px]">
                    ...
                    <span className="text-sm md:text-base">
                      Аналоговые камеры видеонаблюдения, подверженные circuit-bending, ��идеомониторы, DIY управляющая плата (15х10х5 см), объект (15х15х15 см, 3D-печать, гипс), фоторезистор
                    </span>
                  </div>
                </div>
                ...
                <div className="text-base md:text-lg lg:text-xl text-justify leading-relaxed">
                  ...
                  <p>
                    При "краже" объекта-символа пространства галереи типа «белый куб» и системы правил, связанных с восприятием и  демонстрацией искусства, зритель ломает инсталляцию - визуальные артефакты пропадают с телевизоров. В пространстве выставки, суть которой демонстрация ошибки, присутствие чистого изображения и есть ошибка.
                  </p>
                </div>
              </div>
            ...
            <div className="mt-8 md:mt-12">
              ...
              >
                <path d="M84 38.9583V148.042" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M133 93.5L84 148.042L35 93.5" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 lg:gap-12 w-full max-w-7xl">
            ...
            <div className="w-full lg:w-[45%] text-base md:text-lg lg:text-xl text-justify leading-relaxed">
              ...
              <p>
                Circuit-bending - это творческий, основанный на принципах случайности метод модификации схем электронных устройств — низковольтных гитарных эффектов на батарейках, детских игрушек, цифровых синтезаторов, и в данном случае видеокамер — для создания новых музыкальных или визуальных инструментов и генераторов.
              </p>
            </div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-8 lg:gap-12 w-full max-w-7xl">
            <div className="w-full lg:w-[45%] text-base md:text-lg lg:text-xl text-justify leading-relaxed">
              ...
              <p>
                Федя Лакихил — художник сферы новых медиа из России, родился и вырос в городе Люберцы, живет и работает в Москве. Окончил в 2024 году магистратуру ArtTech — «Технологическое искусство» НИТУ МИСИС. Работает в практике глитч-арта, создавая инсталляции, фото- и видеоработы. Его работы выставлялись в таких галереях, как РОСИЗО, Краснохолмская, ГРАУНД Солянка, ЗИЛ (Москва), Волна (Выкса).
              </p>
            </div>
